<!-- Banner GIF -->
<p align="center">
  <img src="https://media.giphy.com/media/qZgHBlenHa1zKqy6Zn/giphy.gif" alt="Obada Banner" width="50%"/>
</p>
...
class Obada:
    def __init__(self):
        self.name = "Obada"
        self.location = "Palestine - Tulkarm"
        self.education = "Computer Science Student"
        self.languages = ["Arabic 🇵🇸", "English 🇬🇧"]
        self.focus = ["Web Development", "Mobile Apps", "Python Tools"]
